...
\begin{itemize}
    ...
    \item \textbf{Kodaira Embedding Theorem:} A compact complex manifold with a positive line bundle is projective (embeddable in projective space).
...
\noindent\textbf{Q: What should I study?} Griffiths--Harris ``Principles of Algebraic Geometry'', Barth--Peters--Van de Ven ``Compact Complex Surfaces'', Friedman ``Algebraic Surfaces and Holomorphic Vector Bundles.''
...
1915 Born Tokyo. 1938 PhD Tokyo (physics). 1940s Switches to mathematics. 1949 IAS Princeton. 1953 Kodaira vanishing theorem. 1954 Kodaira embedding theorem. 1958 Kodaira--Spencer deformation theory. 1960s Classification of surfaces. 1965 Professor Stanford. 1975 Professor IAS Princeton. 1984 Wolf Prize with Lewy. 1997 Dies in Tokyo.

\section*{Exercises}

\begin{enumerate}
    \item Show that for a curve $C$, $\kappa(C) = -\infty$, $0$, or $1$ depending on $g = 0, 1, \geq 2$.
    \item Compute the Hodge numbers of a K3 surface using the Hodge decomposition.
    \item Show that $c_2 = 24$ for a K3 surface (Euler characteristic).
    \item Compute $P_2$ for a surface of general type in terms of $c_1^2$ and $\chi(\mathcal{O}_X)$.
    \item Show that $c_1^2 + c_2$ is always divisible by 12 (Noether's formula).
    \item Classify the possible Hodge diamonds of surfaces with $\kappa = 0$.
    \item Show that an Enriques surface has $c_2 = 12$.
    \item Compute the genus of a smooth curve in a K3 surface.
    \item Show that $\dim H^0(X, K_X) = h^{2,0}$ for a surface.
    \item Show that a rational surface has $p_g = q = 0$.
    \item Show that the Albanese variety of a surface with $\kappa = 0$ is a complex torus.
    \item Prove the Kodaira--Nakano identity for K\"{a}hler manifolds.
    \item Show that the Kuranishi space for a Riemann surface of genus $g \geq 2$ has dimension $3g-3$.
    \item Show that a K3 surface is simply connected.
    \item Show that the Hodge numbers of a complex torus $\mathbb{C}^2 / \Lambda$ are $h^{p,q} = \binom{2}{p}\binom{2}{q}$.
\end{enumerate}
