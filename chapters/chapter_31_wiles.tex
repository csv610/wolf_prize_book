...
\subsection{Elliptic Curves over \texorpdfstring{\(\Q\)}{Q}}
...
\begin{enumerate}
    \item Wiles, A. (1995). Modular elliptic curves and Fermat's Last Theorem. \textit{Annals of Mathematics}, 141(3), 443--551.
    \item Taylor, R., \& Wiles, A. (1995). Ring-theoretic properties of certain Hecke algebras. \textit{Annals of Mathematics}, 141(3), 553--572.
\end{enumerate}

\subsection*{Biographies and Overviews}
\begin{enumerate}
    \item Singh, S. (1997). \textit{Fermat's Last Theorem}. Fourth Estate.
    \item Rubin, K., \& Silverberg, A. (1994). Wiles's proof of Fermat's Last Theorem. \textit{Bulletin of the American Mathematical Society}, 31(1), 15--32.
    \item Aczel, A. D. (1996). \textit{Fermat's Last Theorem: Unlocking the Secret of an Ancient Mathematical Problem}. Four Walls Eight Windows.
\end{enumerate}

\subsection*{Textbooks and Expository Works}
\begin{enumerate}
    \item Silverman, J. H. (2009). \textit{The Arithmetic of Elliptic Curves} (2nd ed.). Springer.
    \item Diamond, F., \& Shurman, J. (2005). \textit{A First Course in Modular Forms}. Springer.
    \item Cornell, G., Silverman, J. H., \& Stevens, G. (Eds.). (1997). \textit{Modular Forms and Fermat's Last Theorem}. Springer.
\end{enumerate}
