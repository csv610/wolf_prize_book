...
\section{Algebraic Analysis and the Theory of \texorpdfstring{\(D\)}{D}-Modules}
...
\subsection{The \texorpdfstring{\(S\)}{S}-Matrix and the Sato School}
...
The Grassmannian \(\Gr\) admits a natural stratification by the index of the Fredholm operator \(W \to H_+\), and it carries a rich geometric structure. In particular, it has a holomorphic line bundle \(\Det\) (the determinant bundle) whose sections give the \(\tau\)-function\index{tau function} of the KP hierarchy.
...
\subsection{Algebraic Analysis and \texorpdfstring{\(D\)}{D}-Modules}
...
\begin{enumerate}
    \item Sato, M. (1959-1960). Theory of hyperfunctions. \textit{Journal of the Faculty of Science, University of Tokyo, Section IA, Mathematics}, 8, 139-193, 387-439.
    \item Sato, M., Kawai, T., \& Kashiwara, M. (1973). Microfunctions and pseudo-differential equations. In \textit{Hyperfunctions and Pseudo-Differential Equations} (pp. 265-529). Springer, Berlin, Heidelberg.
    \item Sato, M., Miwa, T., \& Jimbo, M. (1977). Studies on holonomic quantum fields. I. \textit{Proceedings of the Japan Academy, Series A, Mathematical Sciences}, 53(1), 6-10.
    \item Sato, M. (1970). Theory of prehomogeneous vector spaces. \textit{Nagoya Mathematical Journal}, 37, 1-50.
\end{enumerate}

\subsection*{Biographies and Overviews}
\begin{enumerate}
    \item Kashiwara, M. (2007). Mikio Sato's work on hyperfunctions and algebraic analysis. \textit{Publications of the Research Institute for Mathematical Sciences}, 43(4), 843-861.
    \item Jimbo, M., \& Miwa, T. (2007). Mikio Sato and the theory of integrable systems. \textit{Publications of the Research Institute for Mathematical Sciences}, 43(4), 863-882.
    \item Kawai, T. (2007). Mikio Sato's contributions to the theory of hyperfunctions. \textit{Sugaku Expositions}, 20(2), 195-208.
\end{enumerate}

\subsection*{Textbooks and Expository Works}
\begin{enumerate}
    \item Kashiwara, M., Kawai, T., \& Kimura, T. (1986). \textit{Foundations of Algebraic Analysis}. Princeton University Press.
    \item Schapira, P. (1985). \textit{Microdifferential Systems in the Complex Domain}. Springer, Berlin, Heidelberg.
    \item Bony, J.-M. (1981). \textit{Cours de mathématiques d'après Mikio Sato}. Publications Mathématiques de l'Université Paris VII.
\end{enumerate}
