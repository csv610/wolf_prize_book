...
\begin{enumerate}
    \item Show that $\R^3$ with $\xi = \ker(dz + x\,dy)$ is a contact structure.
    \item Prove that an overtwisted disk cannot exist in the standard tight contact structure on $S^3$.
    \item Show that every closed oriented 3-manifold admits an overtwisted contact structure.
    \item Prove the h-principle for immersions of $S^1$ into $\R^2$.
    \item Show that the boundary of a Stein manifold carries a natural contact structure.
    \item Construct an exotic Stein structure on $\R^4$.
    \item Show that the Reeb vector field of a contact form generates a volume-preserving flow.
\end{enumerate}
