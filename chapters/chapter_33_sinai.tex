...
\begin{enumerate}
    \item Sinai, Ya. G. (1963). On the concept of entropy for a dynamical system. \textit{Doklady Akademii Nauk SSSR}, \textit{148}(4), 768-771. (English translation in \textit{Soviet Mathematics - Doklady}, \textit{4}, 485-488).
    \item Sinai, Ya. G. (1970). Dynamical systems with elastic reflections. \textit{Russian Mathematical Surveys}, \textit{25}(2), 137-189.
    \item Sinai, Ya. G. (1972). Gibbs measures in ergodic theory. \textit{Russian Mathematical Surveys}, \textit{27}(4), 21-69.
    \item Cornfeld, I. P., Fomin, S. V., \& Sinai, Ya. G. (1982). \textit{Ergodic Theory}. Springer-Verlag.
\end{enumerate}

\subsection*{Biographies and Overviews}
\begin{enumerate}
    \item Arnold, V. I., Gelfand, I. M., Kolmogorov, A. N., Novikov, S. P., \& Smirnov, V. I. (1993). Yakov Grigor'evich Sinai (on his 60th birthday). \textit{Russian Mathematical Surveys}, \textit{48}(4), 189-200.
    \item Katok, A. (2003). Yakov Grigor'evich Sinai: A brief biography and an appreciation of his work. In B. Hasselblatt \& A. Katok (Eds.), \textit{Handbook of Dynamical Systems, Vol. 1A: Ergodic Theory and Dynamical Systems} (pp. 1-10). Elsevier.
    \item Sinai, Ya. G. (2009). \textit{Selecta. Volume I: Ergodic Theory and Dynamical Systems}. Springer. (Includes an introductory essay by A. Katok).
\end{enumerate}

\subsection*{Textbooks and Expository Works}
\begin{enumerate}
    \item Katok, A., \& Hasselblatt, B. (1995). \textit{Introduction to the Modern Theory of Dynamical Systems}. Cambridge University Press.
    \item Ruelle, D. (1989). \textit{Chaotic Evolution and Strange Attractors: The Statistical Analysis of Time Series}. Cambridge University Press.
    \item Eckmann, J.-P., \& Ruelle, D. (1985). Ergodic theory of chaos and strange attractors. \textit{Reviews of Modern Physics}, \textit{57}(3), 617-656.
\end{enumerate}
