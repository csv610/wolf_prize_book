...
\begin{enumerate}
    \item Show that the \'etale site on $\Spec k$ recovers the Galois cohomology of $k$.
    \item Prove that any \'etale morphism of curves is unramified.
    \item State and prove the Artin--Rees lemma for finitely generated modules over a Noetherian ring.
    \item Classify Artin--Schelter regular algebras of dimension 2.
    \item Show that the moduli stack $\mathcal{M}_g$ of genus $g$ curves is an algebraic stack.
    \item Prove that an algebraic space that is a scheme in a neighborhood of every point is a scheme.
    \item Compute $H^1_{\et}(\Spec \F_q, \mu_n)$ and relate it to Kummer theory.
\end{enumerate}
