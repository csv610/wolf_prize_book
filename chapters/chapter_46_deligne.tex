...
The Weil conjectures\index{Weil conjectures}, formulated by Andr\'e Weil in 1949, are among the most important problems in algebraic geometry. They predict deep relationships between the topology of algebraic varieties over finite fields and their zeta functions, analogous to the Riemann hypothesis for number fields.
...
Grothendieck's revolutionary insight was that the Weil conjectures could be understood cohomologically. He developed \'etale cohomology\index{\'etale cohomology}, a Weil cohomology theory for algebraic varieties over arbitrary fields, designed to mimic the properties of singular cohomology for complex manifolds.
...
\subsection{The Moduli Stack \texorpdfstring{\(\M_g\)}{Mg}}
...
\subsection{Irreducibility in Characteristic \texorpdfstring{\(p\)}{p}}
...
\begin{enumerate}
    \item Deligne, P. (1974). La conjecture de Weil. I. \textit{Publications Mathématiques de l'IHÉS}, 43, 273--307.
    \item Deligne, P. (1980). La conjecture de Weil. II. \textit{Publications Mathématiques de l'IHÉS}, 52, 137--252.
    \item Deligne, P. (1971). Théorie de Hodge. II. \textit{Publications Mathématiques de l'IHÉS}, 40, 5--57.
    \item Deligne, P. (1974). Théorie de Hodge. III. \textit{Publications Mathématiques de l'IHÉS}, 44, 5--77.
\end{enumerate}

\subsection*{Biographies and Overviews}
\begin{enumerate}
    \item The Norwegian Academy of Science and Letters. (2013). \textit{The Abel Prize Laureate 2013: Pierre Deligne}. Oslo, Norway.
    \item Milne, J. S. (2013). The work of Pierre Deligne. \textit{Notices of the American Mathematical Society}, 60(7), 844--852.
    \item Katz, N. M. (1980). An overview of Deligne's proof of the Riemann hypothesis for varieties over finite fields. In \textit{Proceedings of the International Congress of Mathematicians (Helsinki, 1978)}, Vol. 1, 321--326.
\end{enumerate}

\subsection*{Textbooks and Expository Works}
\begin{enumerate}
    \item Milne, J. S. (1980). \textit{\'Etale Cohomology}. Princeton University Press.
    \item Freitag, E., \& Kiehl, R. (1988). \textit{\'Etale Cohomology and the Weil Conjectures}. Ergebnisse der Mathematik und ihrer Grenzgebiete. 3. Folge / A Series of Modern Surveys in Mathematics, Vol. 13. Springer.
    \item Peters, C. A. M., \& Steenbrink, J. H. M. (2008). \textit{Mixed Hodge Structures}. Ergebnisse der Mathematik und ihrer Grenzgebiete. 3. Folge / A Series of Modern Surveys in Mathematics, Vol. 52. Springer.
    \item SGA 4$\frac{1}{2}$: \textit{Cohomologie \'etale}. Lecture Notes in Mathematics, Vol. 569. Springer, 1977.
\end{enumerate}
