...
Lov\'{a}sz's mathematical style is distinguished by extraordinary breadth and a knack for combining deep algebraic, geometric, and probabilistic insight to solve discrete problems. His name appears throughout the mathematical landscape: the Lov\'{a}sz Local Lemma\index{Lov\'{a}sz Local Lemma}, the LLL lattice reduction algorithm, the Lov\'{a}sz theta function\index{Lov\'{a}sz theta function}, the Lov\'{a}sz--Simonovits method, the Szemer\'{e}di--Lov\'{a}sz theory of graph limits, and the Perfect Graph Theorem. Few mathematicians have had such transformative impact across combinatorics, optimization, algebra, probability, and theoretical computer science.
...
\begin{itemize}
  ...
  \item The maximum weight independent set problem in perfect graphs\index{perfect graph} (the stable set polytope can be separated using the result that the theta function is polynomially computable).
...
\begin{enumerate}
    \item Lovász, L. (1972). Normal hypergraphs and the perfect graph conjecture. \textit{Discrete Mathematics}, 2(3), 253--267.
    \item Lovász, L. (1979). On the Shannon capacity of a graph. \textit{IEEE Transactions on Information Theory}, 25(1), 1--7.
    \item Grötschel, M., Lovász, L., \& Schrijver, A. (1981). The ellipsoid method and its consequences in combinatorial optimization. \textit{Combinatorica}, 1(2), 169--197.
    \item Lenstra, A. K., Lenstra, H. W., Jr., \& Lovász, L. (1982). Factoring polynomials with rational coefficients. \textit{Mathematische Annalen}, 261(4), 515--534.
\end{enumerate}

\subsection*{Biographies and Overviews}
\begin{enumerate}
    \item The Norwegian Academy of Science and Letters. (2021). \textit{The Abel Prize Laureates 2021: László Lovász and Avi Wigderson}. Oslo, Norway.
    \item Wolf Foundation. (1999). \textit{László Lovász: Wolf Prize Laureate in Mathematics}. Herzliya, Israel.
    \item Schrijver, A. (2003). László Lovász: A mathematician of many facets. \textit{European Mathematical Society Newsletter}, 49, 14--17.
\end{enumerate}

\subsection*{Textbooks and Expository Works}
\begin{enumerate}
    \item Lovász, L. (1979). \textit{Combinatorial Problems and Exercises}. North-Holland, Amsterdam.
    \item Lovász, L., \& Plummer, M. D. (1986). \textit{Matching Theory}. North-Holland, Amsterdam.
    \item Grötschel, M., Lovász, L., \& Schrijver, A. (1988). \textit{Geometric Algorithms and Combinatorial Optimization}. Springer-Verlag, Berlin.
    \item Lovász, L., Pelikán, J., \& Vesztergombi, K. (2003). \textit{Discrete Mathematics: Elementary and Beyond}. Springer, New York.
\end{enumerate}
