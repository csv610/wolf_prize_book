...
\begin{itemize}
    ...
    \item \textbf{Ramsey Theory:}\index{Ramsey theory} The Erd\H{o}s--Szekeres bounds $R(s,s) \geq 2^{s/2}$ (lower bound via probabilistic method). The Erd\H{o}s--Rado theorem in partition calculus.
    \item \textbf{Probabilistic Method:}\index{probabilistic method} Pioneered the use of randomness to prove existence of combinatorial structures. Classic example: graphs with large girth and large chromatic number.
...
1913 Born Budapest. 1934 PhD at 21 (University of Budapest). 1934--38 Manchester (postdoc). 1938--40 IAS Princeton. 1940 Erd\H{o}s--Kac theorem. 1941--48 Travels in US (Jewish refugee). 1949 Elementary proof of PNT. 1950s Travels the world. 1959 Random graphs with R\'{e}nyi. 1960 Erd\H{o}s--Gallai theorem. 1961 Erd\H{o}s--Ko--Rado theorem. 1970s Ramsey theory and set theory. 1984 Wolf Prize with Chern. 1996 Dies in Warsaw while attending a conference.

\section*{Exercises for the Reader}
\addcontentsline{toc}{section}{Exercises}\begin{enumerate}
    \item [I] Show that the Erd\H{o}s--Szekeres theorem on monotone subsequences is sharp: for any $n$, construct a sequence of $n^2$ numbers with no monotone subsequence of length $n+1$.
    \item [B] Prove that $R(3,3) = 6$ by showing that $K_5$ can be 2-colored without monochromatic $K_3$, but $K_6$ cannot.
    \item [I] Use the probabilistic method to show $R(k,k) \geq k^{k/2}/e^{k/2}$ (improving the basic bound).
    \item [B] Compute the expected number of isolated vertices in $G(n,p)$ when $p = \log n/n$.
    \item [I] Show that in $G(n, c/n)$ with $c < 1$, the expected number of vertices not in the largest component is $n(1 - \theta(c))$ where $\theta(c)$ is the survival probability.
    \item [I] State and prove the Erd\H{o}s--Ko--Rado theorem for $n \geq 2k$.
    \item [I] Show that the Erd\H{o}s--Gallai inequalities are necessary for a graphical sequence.
    \item [I] Prove Chebyshev's inequality and use it to show that $\omega(n)$ has mean $\log\log n + O(1)$.
    \item [I] Show that the Tur\'{a}n graph $T_{r-1}(n)$ is the unique extremal graph for $K_r$-free graphs.
    \item [I] Compute $\ex(n, C_4)$ using the Kovari--Sos--Turan theorem.
    \item [I] Show that any Sidon set in $[N]$ has size at most $\sqrt{N} + O(N^{1/4})$.
    \item [I] Prove the EGZ theorem for $n$ prime using pigeonhole principle only.
\end{enumerate}
...
1913 & Born in Budapest, Hungary, to Anna and Lajos Erdos. \\ \hline
1930 & Entered Pázmány Péter University in Budapest. \\ \hline
1934 & Awarded Ph.D. in mathematics from Pázmány Péter University at age 21. \\ \hline
1934 & Left Hungary due to growing antisemitism and political instability. \\ \hline
1934--1938 & Postdoctoral fellowship at the University of Manchester, England. \\ \hline
1938 & Moved to the United States, accepting a fellowship at Princeton University. \\ \hline
1940s & Began his lifelong nomadic lifestyle, traveling between universities and collaborating with mathematicians worldwide. \\ \hline
1949 & Published an elementary proof of the Prime Number Theorem with Atle Selberg. \\ \hline
1951 & Denied re-entry to the United States after a trip abroad, due to McCarthy-era suspicions. \\ \hline
1954--1963 & Lived and worked primarily in Israel and Europe, continuing his prolific research. \\ \hline
1963 & Granted permission to re-enter the United States, though his travel was still monitored for some time. \\ \hline
1970s--1980s & Continued his unparalleled output of papers, collaborating with hundreds of mathematicians. \\ \hline
1984 & Awarded the Wolf Prize in Mathematics for his numerous contributions to number theory, combinatorics, probability, and set theory. \\ \hline
1996 & Died in Warsaw, Poland, at the age of 83, while attending a conference. \\ \hline
\end{tabularx}
...
\begin{enumerate}
    \item Erd\H{o}s, P. (1939). On the density of some sequences of numbers. \textit{Journal of the London Mathematical Society}, \textit{14}(1), 12--14.
    \item Erd\H{o}s, P., \& Kac, M. (1940). On the distribution of values of additive functions. \textit{Proceedings of the National Academy of Sciences}, \textit{25}(11), 596--597.
    \item Erd\H{o}s, P., \& Tur\'{a}n, P. (1936). On a problem of Sidon in additive number theory. \textit{Acta Litterarum ac Scientiarum Universitatis Szegediensis, Sectio Scientiarum Mathematicarum}, \textit{8}(3), 207--215.
    \item Erd\H{o}s, P., \& R\'{e}nyi, A. (1959). On random graphs I. \textit{Publicationes Mathematicae Debrecen}, \textit{6}, 290--299.
\end{enumerate}

\subsection*{Biographies and Overviews}
\begin{enumerate}
    \item Hoffman, P. (1998). \textit{The Man Who Loved Only Numbers: The Story of Paul Erd\H{o}s and the Search for Mathematical Truth}. Hyperion.
    \item Schechter, B. (1998). \textit{My Brain is Open: The Mathematical Journeys of Paul Erd\H{o}s}. Simon \& Schuster.
    \item Graham, R. L., \& Spencer, J. H. (2000). \textit{Paul Erd\H{o}s: The Art of Counting}. MIT Press.
\end{enumerate}

\subsection*{Textbooks and Expository Works}
\begin{enumerate}
    \item Aigner, M., \& Ziegler, G. M. (2018). \textit{Proofs from THE BOOK} (6th ed.). Springer.
    \item Alon, N., \& Spencer, J. H. (2008). \textit{The Probabilistic Method} (3rd ed.). John Wiley \& Sons.
    \item Bollob\'{a}s, B. (2001). \textit{Random Graphs} (2nd ed.). Cambridge University Press.
    \item Graham, R. L., Rothschild, B. L., \& Spencer, J. H. (1990). \textit{Ramsey Theory} (2nd ed.). John Wiley \& Sons.
\end{enumerate}
