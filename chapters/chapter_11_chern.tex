...
\begin{itemize}
    ...
    \item \textbf{Chern--Gauss--Bonnet Theorem:}\index{Gauss-Bonnet theorem} The Euler characteristic of a compact orientable Riemannian $2n$-manifold is the integral of the Pfaffian of the curvature: $\chi(M) = (2\pi)^{-n} \int_M \Pf(F)$.
...
1911 Born Jiaxing, China. 1936 PhD Hamburg (under Blaschke). 1937--43 Professor Kunming. 1943--45 IAS Princeton. 1944 Proves Gauss--Bonnet theorem. 1946 Returns to China, founds Institute of Mathematics. 1949 Moves to University of Chicago. 1956 Chern--Weil theory. 1960 Professor at Berkeley. 1970 Chern--Simons invariant. 1974 Chern--Moser theory. 1984 Wolf Prize. 2004 Dies in Tianjin, China.

\section*{Exercises for the Reader}
\addcontentsline{toc}{section}{Exercises}\begin{enumerate}
    \item [I] Show that the first Chern class of the tautological line bundle $\mathcal{O}(-1)$ over $\mathbb{C}P^n$ equals $-h$ where $h$ is the hyperplane class.
    \item [I] Compute $c(T\mathbb{C}P^n)$ using the Euler sequence and verify the total Chern class is $(1 + h)^{n+1}$.
    \item [I] Prove that $c_k(E \oplus F) = \sum_{i+j=k} c_i(E) \cup c_j(F)$ using the splitting principle.
    \item [B] Show that $c_1(E) = c_1(\det E)$ for any complex vector bundle $E$.
    \item [B] Use the Gauss--Bonnet theorem to compute $\chi(S^2)$, $\chi(T^2)$, and $\chi(\mathbb{R}P^2)$.
    \item [A] Compute the Chern--Simons invariant of $S^3$ with the standard connection on $SU(2)$.
    \item [A] Show that the Chern character $\ch$ is a ring homomorphism from $K$-theory to cohomology.
    \item [I] Prove that the Todd class satisfies $\Td(E \oplus F) = \Td(E) \Td(F)$.
    \item [B] For a Riemann surface $\Sigma$ of genus $g$, compute $\int_\Sigma c_1(T\Sigma)$ and verify it equals $2-2g$.
    \item [I] Show that the Chern form $c_1(L, \nabla)$ for a line bundle $L$ is $dA/2\pi i$ where $\nabla = d + A$.
    \item [B] Compute $c_1(\mathcal{O}(k))$ for the $k$-th tensor power of the hyperplane bundle on $\mathbb{C}P^n$.
    \item [B] Prove that $c_2(TS^4) = 0$, consistent with the fact that the Euler characteristic of $S^4$ is 2.
\end{enumerate}
...
1911 & Born in Jiaxing, Zhejiang, China. \\ \hline
1930 & Graduated from Nankai University. \\ \hline
1934 & Received M.S. from Tsinghua University; began studies in Hamburg with Wilhelm Blaschke. \\ \hline
1936 & Earned Ph.D. from University of Hamburg; studied in Paris with Élie Cartan. \\ \hline
1937 & Returned to China, became Professor at Tsinghua University. \\ \hline
1943 & Joined the Institute for Advanced Study in Princeton, USA. \\ \hline
1944 & Published "A Simple Intrinsic Proof of the Gauss-Bonnet Formula for Closed Riemannian Manifolds." \\ \hline
1946 & Returned to China, became Professor at Academia Sinica, Nanjing. \\ \hline
1949 & Moved to the United States, became Professor at the University of Chicago. \\ \hline
1960 & Appointed Professor of Mathematics at the University of California, Berkeley. \\ \hline
1961 & Elected to the National Academy of Sciences. \\ \hline
1979 & Retired from Berkeley, becoming Professor Emeritus. \\ \hline
1982 & Co-founded and became the first Director of the Mathematical Sciences Research Institute (MSRI) in Berkeley. \\ \hline
1984 & Awarded the Wolf Prize in Mathematics for his outstanding contributions to global differential geometry. \\ \hline
2004 & Died in Tianjin, China. \\ \hline
\end{tabularx}
...
\begin{enumerate}
    \item Chern, S.S. (1944). A simple proof of the Gauss-Bonnet formula for Riemannian manifolds. \textit{Annals of Mathematics}, 45(4), 747--752.
    \item Chern, S.S. (1946). Characteristic classes of Hermitian manifolds. \textit{Annals of Mathematics}, 47(1), 85--121.
    \item Chern, S.S. (1951). Differential geometry of fiber bundles. \textit{Proceedings of the International Congress of Mathematicians, Cambridge, MA, 1950}, 2, 397--411. American Mathematical Society.
    \item Chern, S.S. (1956). \textit{Complex manifolds without potential theory}. University of Chicago Press.
\end{enumerate}

\subsection*{Biographies and Overviews}
\begin{enumerate}
    \item Yau, S.-T. (2004). Shiing-Shen Chern, a great geometer of the twentieth century. \textit{Notices of the American Mathematical Society}, 51(11), 1298--1301.
    \item Bott, R. (2005). Shiing-Shen Chern (1911--2004). \textit{Biographical Memoirs of the National Academy of Sciences}, 86, 1--26.
    \item Griffiths, P. (2005). Shiing-Shen Chern (1911--2004). \textit{Proceedings of the American Philosophical Society}, 149(4), 543--548.
\end{enumerate}

\subsection*{Textbooks and Expository Works}
\begin{enumerate}
    \item Kobayashi, S., \& Nomizu, K. (1963). \textit{Foundations of Differential Geometry, Vol. I}. Interscience Publishers.
    \item Milnor, J.W., \& Stasheff, J.D. (1974). \textit{Characteristic Classes}. Princeton University Press.
    \item Warner, F.W. (1983). \textit{Foundations of Differentiable Manifolds and Lie Groups}. Springer-Verlag.
    \item Bott, R., \& Tu, L.W. (1982). \textit{Differential Forms in Algebraic Topology}. Springer-Verlag.
\end{enumerate}
